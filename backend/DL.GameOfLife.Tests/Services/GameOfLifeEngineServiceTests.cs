...
{
    public class GameOfLifeEngineServiceTests
    {
        private readonly GameOfLifeEngineService _gameOfLifeEngineService;
        private readonly Mock<IOptions<GameOfLifeOptions>> _options;


        public GameOfLifeEngineServiceTests()
        {
            ...
            _gameOfLifeEngineService = new GameOfLifeEngineService(_options.Object);
        }
        ...
        public async Task Calculate_ShouldReturnSameBoard_WhenNoCellsAreAlive()
        {
            ...
            // Act
            var result = await _gameOfLifeEngineService.Calculate(board);
        ...
        public async Task Calculate_RuleNumberOne_LiveCellWithFewerThanTwoLiveNeighboursDies()
        {
            ...
            // Act
            var newBoard = await _gameOfLifeEngineService.Calculate(board);
